...
const signals = [
  {
    date: "2026.05.06",
    title: "POLYMARKET",
    note: "New: What will WTI Crude Oil (WTI) hit in May 2026?",
  },
  {
    date: "2026.05.05",
    title: "POLYMARKET",
    note: "Trending: Will the US confirm that aliens exist before 2027?",
  },
  {
    date: "2026.05.03",
    title: "Jupiter",
    note: "Perp: SOL is up 5% in the last 24 hours",
  }
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">BET ON YOUR FUTURE</h2>
      </div>
