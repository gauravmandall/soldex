  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="mb-16">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">SOLDEX TEAM</h2>
      </div>
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        {/* <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">ANON STUDIO</li>
            <li className="font-mono text-xs text-foreground/80">ANON LAB</li>
          </ul>
        </div> */}
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Solana</li>
            <li className="font-mono text-xs text-foreground/80">Magicblock</li>
            <li className="font-mono text-xs text-foreground/80">Turborepo</li>
        ...
        {/* Year */}
        <div className="col-span-1">
          <h4 className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground mb-4">Launch</h4>
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">2026 - v0.1</li>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          COPYRIGHT © 2026 - Soldex. All rights reserved.
        </p>
