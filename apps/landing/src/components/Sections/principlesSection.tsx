  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "ANONYMITY", highlight: true },
        { text: " IS PRIORITY", highlight: false },
      ],
      description: "For those who move in silence.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " OVER EVERYTHING", highlight: false },
      ],
      description: "Data never collected, neither sold.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: " IS KEY", highlight: true },
      ],
      description: "We consider Audits like outfits, we cannot move without it.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: " IS ESSENTIAL", highlight: true },
      ],
      description: "One private platform. Zero footprints.",
      align: "right",
    },
  ]
